...
#
# Vendored from https://github.com/nextcloud/HaRP (exapps_dev/start.sh).
# Generates an frpc config and starts frpc in the background when HaRP is
# the active deploy daemon (HP_SHARED_KEY is set), then execs the ExApp.
# Without HaRP, this is a transparent passthrough that just execs "$@".
